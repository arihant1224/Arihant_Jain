...
if( ! class_exists( 'GSPlugins_projects_free' ) ){
    
    class GSPlugins_projects_free{
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_projects_free ) {
                self::$_instance = new GSPlugins_projects_free();
            }
        ...
        public function gs_plugins_free_menu() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'gs-plugins-free', 
                array( $this, 'gsteam_free_menu_cb' )
                );
        }
        
        public function gsteam_free_menu_cb() { ?>	  
    ...
    $gsplugin_free = GSPlugins_projects_free::get_instance();
}