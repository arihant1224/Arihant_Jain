...
function gs_projects_shortcode( $atts ) {
    ...
    $GLOBALS['gs_projects_loop'] = new WP_Query(
        ...
        if ( $theme == 'gs_project_theme1' || $theme == 'gs_project_theme2') {
            ...
            echo('<h4 style="text-align: center;">Select correct Theme or Upgrade to <a href="https://www.gsplugins.com/product/wordpress-projects-showcase-plugin" target="_blank">Pro version</a> for more Options<br><a href="http://projects.gsplugins.com" target="_blank">Chcek available demos</a></h4>');
        }
